  ...
  <body>
          ...
          <div class="col-md-5">
            <div class="herotext">
              <h1 class="wow bounceInDown" data-wow-duration="1s" data-wow-delay="0.1s">
                <?=$this->e($title)?>
                  <!--Suites <span class="lighter">Atlas</span>--></h1>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <p class="navbar herobuttons">
              <a href="#gallery" class="btn btn-default btn-lg wow fadeInLeft " role="button"> Ver Discografía </a> &nbsp;
              <a href="#testimonials" class="btn btn-default btn-lg wow fadeInTop " role="button"> Testimonios </a> &nbsp;
              <a href="#contactarea" class="btn btn-default btn-lg wow fadeInRight" role="button">Contáctame</a>
            </p>
            <?php } ?>
          </div>
        </div>
    ...
    =============================================== -->
      <section id="credits" class="text-center">
        ...
        <p>Juan Díaz Cavarrubias #319, <br> Colonia San Juan de Dios, Código postal 44360 <br> Guadalajara, Jalisco, México.</p>
      ...
      </span><br/> Copyright &copy; <a href="#">ANTONIO HUERTA</a>
