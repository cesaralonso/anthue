<?php $this->layout('master', ['title' => 'Services', 'main' => false, 'description' => 'Cursos para principiantes y avanzados.']) ?>
<!-- SERVICES
	================================================== -->

<section id="faq" class="parallax section" style="background-image: url(assets/images/piano1.jpg);">
